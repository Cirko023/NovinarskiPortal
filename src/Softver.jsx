...
function Softver() {
    ...
    return (
        ...
        <div className='flex flex-row justify-center items-center gap-10 mb-40 mt-40 bg-linear-to-r/hsl from-gray-900 to-gray-600 w-full h-130'>
            <div className='cursor-pointer' onClick={() => handleKlik('Windows 12 Recenzija')}>
                <Kartica3 slika='./windows12.jpg' imeSlike='Windows 12' tekst='Windows 12 Recenzija' />
            </div>
            <div className='cursor-pointer' onClick={() => handleKlik('Adobe vs Free Alternatives')}>
                <Kartica3 slika='./adobe.jpg' imeSlike='Adobe vs Free' tekst='Adobe vs Free Alternatives' />
            </div>
            <div className='cursor-pointer' onClick={() => handleKlik('Best Video Editing Software')}>
        ...
        <div className='flex flex-col justify-center'>
            <div className='cursor-pointer' onClick={() => handleKlik('Microsoft Office 2026')}>
            ...
            <div className='cursor-pointer' onClick={() => handleKlik('Antivirus software')}>
            ...
            <div className='cursor-pointer' onClick={() => handleKlik('AI coding alati')}>
